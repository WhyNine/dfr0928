...
/*
 * DRM driver for DFR0928 display panel which uses the 
 * ST7735R controller, connected via SPI. 
 *
 * Based on https://github.com/raspberrypi/linux/blob/rpi-5.15.y/drivers/gpu/drm/tiny/st7735r.c
 */
...
static const struct st7735r_cfg dfr0928_cfg = {
...
static const struct of_device_id st7735r_of_match[] = {
	{ .compatible = "dfrobot,dfr0928a", .data = &dfr0928_cfg },
	{ },
};
MODULE_DEVICE_TABLE(of, st7735r_of_match);

static const struct spi_device_id st7735r_id[] = {
	{ "dfr0928a", (uintptr_t)&dfr0928_cfg },
	{ },
};
...
MODULE_DESCRIPTION("DF Robot DFR0928 DRM driver");
MODULE_AUTHOR("Simon Waller <waller_as@yahoo.co.uk>");
MODULE_LICENSE("GPL");